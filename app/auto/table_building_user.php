...
<?php
$i = 0;
$get_total = $getdata->my_sql_select($connect, NULL, "building_list", "(card_status is null or card_status NOT IN ('57995055c28df9e82476a54f852bd214','2e34609794290a770cb0349119d78d21')) AND (user_key = '" . $_SESSION['ukey'] . "' OR se_namecall = '" . $_SESSION['ukey'] . "') ORDER BY ticket DESC LIMIT 30");
