<?php
$card_detail = $getdata->my_sql_query($connect, NULL, "building_list", "department ='" . htmlspecialchars($_GET['key']) . "'");
?>
...
<div class="row">
   <div class="col-lg-12">
      <h3 class="page-header"><i class="fa fa-chart-bar fa-fw"></i> รายการแจ้งใช้บริการของแผนก <u><?php echo @prefixConvertorDepartment($card_detail->department); ?></u></h3>
   </div>
</div>
